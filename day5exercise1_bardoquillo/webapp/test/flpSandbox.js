		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpday5exercise1bardoquillo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercise1bardoquillo-display": {
								"semanticObject": "zbtpday5exercise1bardoquillo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercise1bardoquillo",
									"url": sap.ui.require.toUrl("zbtp/day5exercise1bardoquillo")
								}
							}
						}
					}
